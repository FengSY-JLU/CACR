...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="checkpoints/UIEBD_contributor_0603_manifold_woopt_ablation/model_epoch_200.pth")
    ...
    parser.add_argument("--indicator", type=str, default="UIEBD_contributor_0603_manifold_woopt_ablation")
    parser.add_argument("--output_folder", type=str, default="Results_contributor_0603_manifold_woopt_ablation/")
    ...
    restormer_path_woruie = (
        "./src/model/restormer/best_restormer_prior_woruie.pth"
    )
    ...
    if os.path.exists(restormer_path_woruie):

        learned_prior_cfgs.append(
            {
                "type":"restormer",
                "path":restormer_path_woruie,
                "name":"woRUIE"
            }
        )
